...
function drawAvailableUnits(avalableUnitBox: { width: number; height: number; getContext: (arg0: string) => { (): any; new(): any; clearRect: { (arg0: number,arg1: number,arg2: any,arg3: any): any; new(): any; }; }; }, germanUnit: string|any[]) {
